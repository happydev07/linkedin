...
query_file_path = 'C:\\Users\\devra\\Desktop\\EasyApply_JobApplication\\prompt.txt'
...
if query_text:
    ...
    try:
        ...
        if response_content:
            ...
            delete_if_exists('C:\\Users\\devra\\Desktop\\EasyApply_JobApplication\\AwsDevopsDeoraj.docx')
            copy_and_modify_docx('C:\\Users\\devra\\Desktop\\EasyApply_JobApplication\\deoraj.docx', 
                                 'C:\\Users\\devra\\Desktop\\EasyApply_JobApplication\\AwsDevopsDeoraj.docx', 
                                 response_content)
    except Exception as e:
